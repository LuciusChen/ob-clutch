;;; ob-redis.el --- Org-Babel Redis compatibility shim -*- lexical-binding: t; -*-
...
;; Org-Babel Redis support via clutch.
;; Loads `ob-clutch', which defines `org-babel-execute:redis'.
