;;; ob-mongodb.el --- Org-Babel MongoDB compatibility shim -*- lexical-binding: t; -*-
...
;; Org-Babel MongoDB support via clutch.
;; Loads `ob-clutch', which defines `org-babel-execute:mongodb'.
